...
// until real ones are written; see content/reviews/README.md for the
// exact fields a real one needs. app/reviews/page.tsx handles the
// zero-reviews state honestly rather than needing fake content to look
// "finished".
export const Review = defineDocumentType(() => ({
  ...
  fields: {
    ...
    // e.g. "Independent Financial Adviser" or "Will Writer, Smith & Co" —
    // role/business, not used for per-partner attribution beyond this.
