...
Start with the account itself. Signing up takes minutes: create your account, verify your email, and you're straight onto the platform. The trial is genuinely free for 14 days, no card required to start exploring.

Use the rest of day one to read through the terms and get familiar with the dashboard — Customers, Leads, Campaigns, Document Suite, Estate Planning Website and Marketing Info. You don't need to touch all of it yet, just know where everything lives.
