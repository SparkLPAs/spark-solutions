...
## The two ways to build the revenue line

Spark Solutions offers two partner models that suit most mortgage brokerages, depending on appetite for setup and brand control.

**White-Label Partner.** You get a fully rebranded platform — your logo, your domain, your colours — and your clients never see the Spark Solutions name. You connect your own Stripe account and take payment directly, with Spark Solutions charging a flat monthly platform fee rather than a cut of revenue. This maximises margin per client but requires a little more setup time up front.

**Branded Consultant.** You operate under the Spark Solutions brand, which means a faster launch and a lower ongoing cost, in exchange for slightly less control over presentation. This suits brokers who want to test the water before committing to a fully white-labelled offer.

Both routes plug into the same client-facing wizard for wills, trusts and LPAs, so the quality of what your client actually receives doesn't change — only the branding and the commercial terms do.
...
[Book a free demo](/demo) and we'll walk through exactly what a White-Label or Branded Consultant setup looks like for a brokerage your size.
